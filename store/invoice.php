...
$rad = Database::s("SELECT * FROM `address` WHERE `user_user_id`='" . $_SESSION['user']['user_id'] . "' ");
$nrad = $rad->num_rows;
    ...
    <div style="padding: 20px;box-sizing: border-box; background-image:url('');background-repeat: no-repeat;background-position: center;width:100%;height: 100%;position:absolute;background-size: contain;overflow-y: auto;overflow-x: auto;display: flex;">
        <div class="inv" id="inv">
            ...
            <table style="text-align:center;width: 100%;margin-top: 100px;white-space:wrap;margin-bottom: 100px;">
                ...
                <tr>
                    <!-- <td style="font-family: 'hacker';letter-spacing: 2px;" colspan="4">Delivery Fee_</td>
                                <td style="font-family: 'hacker';letter-spacing: 2px;;">300 Rs</td> -->
            ...
            <p style="font-family: 'hacker';letter-spacing: 2px;text-align: center;font-size: smaller;margin: 0;margin-bottom: 10px;">Contact Us : +94 717272227 </p>
        </div>
    </div>
